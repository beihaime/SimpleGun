...
public class ProjectileTntRenderer extends EntityRenderer<ProjectileTnt> {

    private final ItemRenderer itemRenderer;

    public ProjectileTntRenderer(EntityRendererProvider.Context context) {
        super(context);

        this.itemRenderer = context.getItemRenderer();
    }
    @Override
    public ResourceLocation getTextureLocation(ProjectileTnt entity) {
